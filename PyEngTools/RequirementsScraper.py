...
class RequirementsScraper:
    ...
    def convert_string_to_regex(search_string):
        pass
        ...
        for input_pdf in input_pdfs:
            ...
            for page in pages:
                ...
                for table in tables:
                    ...
                    page_text = self._remove_table_text(page_text, table_text, table_index)

                    if extract_tables:
                        self._table_to_image(page, table, table_index, self.output_path)
                    all_text += page_text
